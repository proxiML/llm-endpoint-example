...
title = """<h1 align="center"><a href="https://www.proximl.ai"><div style="display:flex; justify-content: center;"><img style="max-width:250px" src="https://www.proximl.ai/img/logo.svg" /></div></a></h1><h2 align="center"> Large Language Model Endpoint Demo</h2>"""
description = """<br>
...
with gr.Blocks(
    title="proxiML LLM Endpoint Demo",
    theme=theme,
) as demo:
    gr.HTML(title)
    with gr.Row():
